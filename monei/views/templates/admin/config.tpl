<form id="configuration_form" class="defaultForm form-horizontal MoneiPaymentPlatform"
      action="index.php?controller=AdminModules&amp;configure=monei&amp;token={{$token}}"
      method="post" enctype="multipart/form-data" novalidate="">
    <input type="hidden" name="submitmonei" value="1">
    ...
    <div class="oppcw-backend-form" id="moneiConfigForm">
        ...
        <div class="panel">
                    ...
                    <div class="col-lg-12">
                        <div class="testMode">
                            <input type="checkbox"
                                   ...
                                   id="operationMode_testMode" {if $defaultValues['operationMode_testMode']!=null}checked="checked"{/if}>

                            <label for="operationMode_testMode">Test Mode</label>
                        </div>
                        <p class="help-block">
            ...
            <div class="panel-footer">
                <button type="submit" value="1" id="configuration_form_submit_btn" name="submitmonei"
                        class="pull-left">
