            ...
            <div class="tabbable" id="tabs-270581">
                <ul class="nav nav-tabs">
                    <li class="{if !(isset($pbtab))}active{/if}">
                        <a href="#panel-info" data-toggle="tab"><i
                                    class="icon icon-info-circle"></i> {l s='Information' mod='monei'}</a>
                    </li>
                    <li>
                        <a href="#panel-conf-1" data-toggle="tab"><i
                                    class="icon icon-cogs"></i> {l s='Settings' mod='monei'}</a>
                    </li>
                    <li>
                        <a href="#panel-conf-2" data-toggle="tab"><i
                                    class="icon icon-money"></i> {l s='Payment methods' mod='monei'}</a>
                    </li>
                    <li>
                        <a href="#panel-conf-3" data-toggle="tab"><i
                                    class="icon icon-shopping-cart"></i> {l s='Payment Status' mod='monei'}</a>
                    </li>
                    <li>
                        <a href="#panel-docs" data-toggle="tab"><i
                                    class="icon icon-book"></i> {l s='Documentation' mod='monei'}</a>
                    </li>
                </ul>
                <!-- TABS -->
