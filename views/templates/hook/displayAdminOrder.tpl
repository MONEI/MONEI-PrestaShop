        ...
        <ul class="nav nav-tabs d-print-none" role="tablist">
            <li class="nav-item">
                <a class="nav-link show active" data-toggle="tab" href="#moneiGeneralTabContent"><i
                        class="material-icons">payment</i>&nbsp;{l s='Payments' mod='monei'}</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#moneiRefundsTabContent"><i
                        class="material-icons">money_off</i>&nbsp;{l s='Refunds' mod='monei'}</a>
            </li>
        </ul>
                    ...
                    {if $isRefundable}
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <input type="hidden" value="{$orderId|escape:'html':'UTF-8'}" id="monei_order_id" />
