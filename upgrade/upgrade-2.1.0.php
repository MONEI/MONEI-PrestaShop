...
/**
 * Upgrade to 2.1.0 - express checkout, split card fields, automatic capture.
 *
...
function upgrade_module_2_1_0($module)
{
    try {
        ...
        foreach ($hooks as $hook) {
            ...
            // ⚠️ Judge the outcome, not registerHook()'s return value. It answers
        ...
        Monei::logError('[MONEI] Upgrade to 2.1.0 failed: ' . $e->getMessage());
