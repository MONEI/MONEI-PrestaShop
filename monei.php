...
class Monei extends PaymentModule
{
    ...
    public static function getLogLevel($level = 'info')
    {
        ...
        // Fallback for PrestaShop 1.7.3 - use numeric values
        $levels = [
            'info' => 1,
            'warning' => 2,
            'error' => 3,
    ...
    {
        // PrestaShop 1.7.3 uses Bootstrap 3 in admin
    ...
    {
        // Load required assets for jsonViewer (needed for PrestaShop 1.7.3 compatibility)
    ...
    private function formatPrice($price, $currencyIso)
    {
        ...
        // PrestaShop 1.7.3 compatibility - use Tools::displayPrice instead of getContextLocale
