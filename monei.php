...
class Monei extends PaymentModule
{
    ...
    public function hookModuleRoutes()
    {
        return [
            ...
            'module-monei-applepay-wellknown' => [
                'controller' => 'applepay',
                'rule' => '.well-known/apple-developer-merchantid-domain-association',
                'keywords' => [],
                'params' => [
    ...
    private function copyApplePayDomainVerificationFile()
    {
        ...
        $letsEncryptDir = '/opt/bitnami/apps/letsencrypt/.well-known';
    ...
    private function removeApplePayDomainVerificationFile()
    {
        ...
        $letsEncryptFile = '/opt/bitnami/apps/letsencrypt/.well-known/apple-developer-merchantid-domain-association';
    ...
    private function checkApplePayDomainVerification()
    {
        ...
        if (!Configuration::get('MONEI_APPLE_GOOGLE')) {
            return null;
        }
        ...
        // File is accessible, save verification status
    ...
    private function getApplePayDiagnosticInfo()
    {
        ...
        $locations = [
            ...
            'Let\'s Encrypt .well-known' => '/opt/bitnami/apps/letsencrypt/.well-known/apple-developer-merchantid-domain-association',
        ];
