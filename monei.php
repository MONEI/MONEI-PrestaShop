...
class Monei extends PaymentModule
{
    ...
    {
        // Check if PrestaShop 1.7.12+ constants exist
        ...
        // Fallback for PrestaShop 1.7.12 - use numeric values
        $levels = [
            'info' => 1,
            'warning' => 2,
            'error' => 3,
    ...
    {
        // PrestaShop 1.7.12 uses Bootstrap 3 in admin
        // PrestaShop 1.7.12+ uses Bootstrap 4 in admin
        // Note: All PrestaShop 1.7.x versions use Bootstrap 4 in the frontend (Classic theme)
        // but the admin panel transitioned from Bootstrap 3 to 4 in 1.7.12
        return version_compare(_PS_VERSION_, '1.7.12.0', '>=') ? 4 : 3;
    }
    ...
    public function getModalAttributes()
    {
        ...
        // PrestaShop 1.7.x (including 1.7.12) uses Bootstrap 3/4 which use data-* attributes
    ...
    public function checkPHPCompatibility()
    {
        ...
        // PS 1.7.12+ requires PHP 7.1.3+
        if (version_compare($psVersion, '1.7.12.0', '>=') && version_compare($phpVersion, '7.1.3', '<')) {
            return [
                'compatible' => false,
    ...
    {
        // Load required assets for jsonViewer (needed for PrestaShop 1.7.12 compatibility)
    ...
    public function hookActionOrderSlipAdd($params)
    {
        try {
            ...
            // Also check POST parameters for partial shipping refund (PrestaShop 1.7.2 - 1.7.12 compatibility)
    ...
    private function formatPrice($price, $currencyIso)
    {
        ...
        // PrestaShop 1.7.12 compatibility - use Tools::displayPrice instead of getContextLocale
    ...
    /**
     * Hook to add capture payment button to order actions (PS 1.7.12+)
     *
     * @param array $params Hook parameters containing order information
     */
    public function hookActionGetAdminOrderButtons(array $params)
    {
        // This hook only exists in PrestaShop 1.7.12+
