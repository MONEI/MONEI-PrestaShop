...
class Monei extends PaymentModule
{
    ...
    public static function getLogLevel($level = 'info')
    {
        ...
        // Fallback for PrestaShop 1.7.4 - use numeric values
        $levels = [
            'info' => 1,
            'warning' => 2,
            'error' => 3,
    ...
    {
        // PrestaShop 1.7.4 uses Bootstrap 3 in admin
    ...
    {
        // Load required assets for jsonViewer (needed for PrestaShop 1.7.4 compatibility)
    ...
    public function hookActionOrderSlipAdd($params)
    {
        try {
            ...
            // Also check POST parameters for partial shipping refund (PrestaShop 1.7.2 - 1.7.8 compatibility)
    ...
    private function formatPrice($price, $currencyIso)
    {
        ...
        // PrestaShop 1.7.4 compatibility - use Tools::displayPrice instead of getContextLocale
